  ...
  const handleSubmit = async (data: RegistrationFormData) => {
    ...
    try {
      ...
      if (residentResponse.status === 201) {
        // Success
        toast.success(
          "Resident pre-registration submitted successfully. Please ask the resident to check their email for the verification."
        );
...
export default AdminPreRegister;
